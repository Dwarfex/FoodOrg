...
if (!isset($sePageParameter[0])) {
    ...
    $showPerPage = (int) $sePageParameter[0];
    if($showPerPage < 1)$showPerPage = 1;
...
$sitehtml='<div class="row"><div class="col-md-12"><h1>Zufällige Rezepte</h1></div></div>
...
$maxCount = $recipeController->getCollectionCount();



    $randomId = rand(1, $maxCount);
    $recipes = $recipeController->findLimitSkip($showPerPage, $randomId);
